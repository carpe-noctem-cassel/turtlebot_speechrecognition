...
// (in-package speechrecognition.srv)
...
class AddTwoIntsRequest {
  ...
  static datatype() {
    ...
    return 'speechrecognition/AddTwoIntsRequest';
  }
...
class AddTwoIntsResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'speechrecognition/AddTwoIntsResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'speechrecognition/AddTwoInts'; }
};
